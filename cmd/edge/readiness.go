...
func (state *ReadinessState) MarkReady() {
	state.ready.Store(true)
}

func (state *ReadinessState) MarkNotReady() {
...
func (state *ReadinessState) ServeHTTP(response http.ResponseWriter, request *http.Request) {
	response.Header().Set(
		"Content-Type",
...
func stopReadinessServer(server *http.Server, edgeID string) {
