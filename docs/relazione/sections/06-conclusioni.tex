...
esplicito della politica event-time studiata. Una sorgente che rimane indietro
...
Le repliche Cloud condividono il medesimo host Workers e sono eseguite con i
...
uno a quattro Cloud Worker, la mediana della global emission latency diminuisce
di circa il 40\% e il p95 di circa il 32\%. L'aumento a sei Worker non produce
un ulteriore miglioramento e mostra una lieve regressione nei percentili di
coda. I risultati evidenziano quindi un beneficio del parallelismo nel range
analizzato, con rendimenti decrescenti prima del limite di sei Worker imposto
dal numero di partizioni Kafka.
