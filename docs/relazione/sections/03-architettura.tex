...
aggregati, watermark ed End of Stream (EOS) dello stesso Edge nella stessa partizione.
...
Una partizione Cloud può contenere Edge con velocità differenti. Quando apre
una nuova finestra, ciascun Edge pubblica un watermark esplicito dopo
l'aggregato appena chiuso. Il worker memorizza, per ogni Edge atteso, il
watermark monotono e l'eventuale EOS. Finché un Edge non ha prodotto un
watermark né EOS, non è possibile certificarne il progresso. Tra gli Edge non
terminati si considera il minimo dei watermark: solo gli intervalli interamente
