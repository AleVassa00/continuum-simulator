...
Il minimo dei watermark Edge evita risultati prematuri ma può trattenere
...
significato degli output al variare delle repliche. Watermark espliciti,
progresso di partizione ed EOS permettono di concludere le finestre soltanto
quando ogni contributo è determinato, includendo le sorgenti senza dati.
