...
Come possibile sviluppo futuro, i risultati persistiti su Amazon RDS
potrebbero essere esposti tramite un livello di accesso serverless, ad esempio
utilizzando AWS Lambda per eseguire query sugli aggregati globali e renderli
disponibili ad applicazioni o servizi esterni.