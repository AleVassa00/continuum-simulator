...
Lo scenario è stato costruito a partire dal dataset pubblico
...
effettuata senza sostituzione utilizzando un seed pseudo-casuale fissato.
In questo modo ogni Edge partecipa in maniera comparabile agli esperimenti,
pur mantenendo le differenze naturali nel tasso di generazione degli eventi.

Infine, la fase di preprocessing produce due tipi di artefatti utilizzati
durante l'esecuzione: il file rappresentante la topologia, che associa i
