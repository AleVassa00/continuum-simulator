...
che l'Edge non produrrà successivamente aggregati con estremo superiore
precedente o uguale a tale istante. Aggregato e progresso viaggiano nello
stesso record, evitando che la certificazione possa precedere i dati cui si
riferisce.
...
emessa quando il proprio estremo superiore non è successivo a $W_P$. Negli
esperimenti principali $S$ viene mantenuto sufficientemente ampio da non
forzare l'avanzamento della frontiera: la completezza dipende quindi dal
progresso naturale di tutti gli Edge della partizione.
...
pendenti nel commit. Il Global Aggregator applica lo stesso principio,
