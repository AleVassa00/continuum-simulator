...
ridurre la quantità di dati che deve essere trasferita verso il Cloud rispetto
all'invio di ogni singola osservazione.
...
L'applicazione è sviluppata interamente in Go, containerizzata tramite Docker
e distribuita su AWS mediante un processo di deployment automatizzato.